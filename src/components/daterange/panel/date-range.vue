        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="leftCurrentView !== 'time'">
                    ...
                    <span
                        :class="{datePrefixCls: true, '-header-label': true, 'left-date': leftCurrentView !== 'year' && leftCurrentView !== 'month'}"
                    ...
                    <span
                        ...
                        @click="nextYear('left')"
                        v-show="leftCurrentView === 'year' || leftCurrentView === 'month'">
                        <i class="nextyear"></i>
                        </span>
                </div>
                <date-table
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="rightCurrentView !== 'time'">
                     <span
                         ...
                         v-show="rightCurrentView === 'year' || rightCurrentView === 'month'">
                         <i class="prevyear"></i>
                         </span>
                    <span
                        :class="{datePrefixCls: true, '-header-label': true, 'right-date': rightCurrentView !== 'year' && rightCurrentView !== 'month'}"
...
<style scoped>
.ivu-date-picker-next-btn-arrow-double i:after, .ivu-date-picker-prev-btn-arrow-double i:after{
    content: ''
}
